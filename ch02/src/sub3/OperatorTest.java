...
public class OperatorTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("result5 : " + result5); // 나머지 구하는 연산자
		...
		boolean rs1 = var1 > var2; // 참거짓의 자유형 var1이 var2보다 크다.
		boolean rs2 = var1 < var2; // var1이 var2보다 작다.
		boolean rs3 = var1 >= var2; // var1이 var2보다 크거나 같다.
		boolean rs4 = var1 <= var2; // var1이 var2작거나 같다.
